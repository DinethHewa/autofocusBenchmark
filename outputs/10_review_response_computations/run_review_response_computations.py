...
This folder contains isolated supporting computations for the associated manuscript. The scripts and outputs here read existing pipeline artifacts and write only under `outputs/10_review_response_computations/`.
