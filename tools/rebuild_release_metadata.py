...
def main() -> None:
    parser = argparse.ArgumentParser(description="Rebuild release inventory, checksums, and optional tar.gz archive")
    parser.add_argument("--archive", action="store_true", help="Also rebuild the package tar.gz and checksum sidecar")
